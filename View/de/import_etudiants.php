...
$pageTitle = "Import CSV - Étudiants";
$nbNotifs = Notification::compterNonLus($_SESSION['idCompte']);
?>
<?php
$pageTitle   = "Import des étudiants";
...
<div class="sidebar">
  ...
  <?php if (isset($_SESSION['succes'])): ?>
    ...
    <div class="card">
      <div class="card-title"> Import CSV - Étudiants</div>
      
      <div class="alert alert-info" style="margin-bottom:1.5rem;">
        <strong>Format CSV requis :</strong><br>
        Le fichier CSV doit contenir les colonnes suivantes dans l'ordre :<br>
        <code>idUtilisateur,nom,prenom,email,dateNaissance,filiere,option_etu,niveau</code><br><br>
        <strong>Exemple :</strong><br>
        <code>2021GE0234,Dupont,Jean,jean@uatm.ga,2000-05-15,Génie Électrique,Système informatique et logiciel,M2</code><br>
        <code>2021GEST0156,Martin,Marie,marie@uatm.ga,2001-03-22,Gestion,Finance,M1</code><br><br>
        <strong>Note :</strong> La colonne option_etu est optionnelle.
      </div>
      ...
      <form method="POST" action="../../Controller/traitement_auth.php" enctype="multipart/form-data">
        <div class="frow">
          ...
          <div class="fg" style="display:flex;align-items:flex-end;">
            <button class="btn btn-primary btn-full" type="submit" name="btn_import_etudiants">Importer</button>
          </div>
        </div>
      </form>

      <div style="margin-top:1.5rem;padding-top:1.5rem;border-top:1px solid var(--gray-200);">
        <a href="liste_etudiants.php" class="btn btn-ghost">← Retour à la liste</a>
      </div>
    </div>
<?php layout_close(); ?>