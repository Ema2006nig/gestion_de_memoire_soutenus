...
$prof      = new Professeur($_SESSION['idUtilisateur'], $_SESSION['nom'], $_SESSION['prenom'], '', '');
    ...
    <div class="card">
      ...
      <div style="background:#f9f9f9;padding:1rem;border-radius:8px;margin-bottom:1.5rem;">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:.8rem;">
          ...
          <div>
            <label style="font-size:.7rem;color:var(--gray-500);display:block;margin-bottom:.2rem;">Spécialité</label>
            <div style="font-size:.82rem;font-weight:600;color:var(--gray-800);"><?= htmlspecialchars($_SESSION['specialite'] ?? '') ?></div>
          </div>
          <div>
